import { Autocomplete, Box, Chip, FormHelperText, InputLabel, TextField } from "@mui/material";
...
export default function CityAutoField(props) {
  ...
  return (
    <>
      ...
      />
      <FormHelperText error={!!error}>{!!error ? error : HELPER_TXT_MSG.defaultText}</FormHelperText>
    </>
  );
}
